    ...
    return (
        <div className='navbar'>
            <div className="menu">
                ...
                <NavLink to="/p1" className={({ isActive }) => isActive ? 'nav-item active' : 'nav-item'}>Page 1</NavLink>
                <NavLink to="/p2" className={({ isActive }) => isActive ? 'nav-item active' : 'nav-item'}>Page 2</NavLink>
            </div>
